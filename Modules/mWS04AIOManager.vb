...
Module mWS04AIOManager
    ...
    Public Property AnalogInputFineOffset(ByVal index As eAnalogInput) As Double
        ...
        Set(ByVal value As Double)
            '
            If (index = eAnalogInput.WS04_IBAT) Then
    ...
    Public Function PowerUp() As Boolean
        ...
        PowerUp = LoadCalibration(mWS04Main.Settings.AIOCalibrationPath)
        ' Create the task
    ...
    '                If (sample(i) < 0) And i <> eAnalogInput.WS04_EarlySensor And i <> eAnalogInput.WS04_StrenghtSensor Then
    '                    sample(i) = 0
    '                End If
    '            Next
    '            ' Return False

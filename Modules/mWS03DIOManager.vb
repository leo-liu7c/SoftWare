    ...
    Public ReadOnly Property DigitalOutputDescription(ByVal index As eDigitalOutput) As String
        Get
            Select Case index
                ...
                Case eDigitalOutput.DO_Jama_UP
                    DigitalOutputDescription = "DO JAMA_UP"
                Case eDigitalOutput.DO_Jama_DN
                    DigitalOutputDescription = "DO JAMA_DN"
    ...
    Public Function PowerUp() As Boolean
        ...
        If (_hardwareEnabled) Then
            Try
                ...
                _writerTask.DOChannels.CreateChannel(mWS03Main.Settings.AIOInterface & "/port0/line0:15,", "", _
